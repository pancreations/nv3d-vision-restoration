...
int main(){try{
    ...
    for(int version:{3,4}){
        ...
        require(saved.find("ghost_")==std::string::npos&&saved.find("cross ")==std::string::npos&&saved.find("version 8")!=std::string::npos,"Migrated profiles cannot restore cross-eye blending or subtraction");
